 ...
 * <p>
 */
public class ChoicesPlugin extends Plugin {
	...
	public String getConfigurationDijitClass() {
		return "choicesPluginDojo.ConfigurationPane";
	}
	...
	/**
	    ...
	    public com.ibm.ecm.extension.PluginFeature[] getFeatures() {
	       return new com.ibm.ecm.extension.PluginFeature[] {new net.choices.feature.ChoicesFeature()};
	    }
